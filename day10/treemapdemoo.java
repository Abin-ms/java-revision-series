...
public class treemapdemoo {
    ...
    public static void main(String[] args) {
        ...
        students.put(new Student1(102, "Rahul", 85), "Student 3"); // Same marks as John -> sorted by name ("John" before "Rahul")
        students.put(new Student1(104, "Alice", 85), "Student 4"); // Same marks as John/Rahul -> sorted by name ("Alice" first)
